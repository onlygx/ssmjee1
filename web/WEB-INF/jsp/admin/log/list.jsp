        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="btn-group">
                    ...
                    <a href="#module=log/add" class="btn green">
    ...
    <div class="portlet-body table-responsive">
        ...
        <table style="width: 100%;" class="table table-striped table-bordered" id="table">
            ...
            <c:forEach var="data" items="${pageInfo.list}" varStatus="status">
                <tr class="${data.status==0?'error':''}">
                    <td class="center"><input type="checkbox" class="checkboxes" value="${data.id}"/></td>
                    <td>${ssm:dateToStringTime(data.setTime)}</td>
                    <td>
                        <label title="${data.content}">
                            ${ssm:showStringLength(data.content,30)}
                        </label>
                    </td>
                    ...
                    <td>
                        ...
                        <a href="#module=log/edit&id=${data.id}">查看\编辑</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
