...
class ModuleConfig {
    ...
    private String qianzui;             //模块表名称前缀,不用带下划线 例如 t
     ...
     * 开始生成
     */
    void startGenerator(String qianzhui){

        this.qianzui = qianzhui;
    ...
    private void createMapper(){
        ...
        /*创建一个数据模型 Create a data model */
        Map root = DataModuleBuild.createMapperDataModle(moduleName,clazz,qianzui);
