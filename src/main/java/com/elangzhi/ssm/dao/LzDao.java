...
public class LzDao<T> {
     ...
     */
    public Long count(String statement, Object parameter) throws Exception {
        return sqlSessionTemplate.selectOne(statement,parameter);
    }
     ...
     */
    public List<T> arrayList(String statement, Object parameter) throws Exception {
     ...
     * @throws Exception 获取失败
     */
    public List<T> arrayList(String statement, Object parameter, RowBounds rowBounds) throws Exception {
     ...
     * @throws Exception 获取失败
     */
    public List<Map> map(String statement, Object parameter) throws Exception {
        return sqlSessionTemplate.selectList(statement, parameter);
    }
